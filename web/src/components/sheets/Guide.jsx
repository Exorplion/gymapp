...
export default function Guide() {
  ...
  return (
    <div ref={rootRef}>
      ...
      <div className="text-sm leading-relaxed text-mut">Variar 1-2 kg en un día es normal (agua, glucógeno, sodio, digestión). Pésate a diario en las mismas condiciones y mira el <b className="text-txt">promedio semanal</b>, no el número de un día suelto.</div>
      ...
      <div className="text-sm leading-relaxed text-mut">5 g/día todos los días (incluso descanso), sin fase de carga; el timing da igual, solo importa la constancia. Sube +1-2 kg en la balanza los primeros 7-10 días por <b className="text-txt">agua intracelular — no es grasa</b>.</div>
      <h3 className="mt-4 mb-1.5 font-cond text-lg font-semibold text-txt">🏃 Cardio en déficit</h3>
      <div className="text-sm leading-relaxed text-mut">El cuello de botella de perder grasa casi nunca es el cardio, es el control calórico. En días de descanso, 25-30 min moderados suman ~200-250 kcal. Evítalo justo después de sesiones largas de pesas (interfiere con la recuperación).</div>
      <h3 className="mt-4 mb-1.5 font-cond text-lg font-semibold text-txt">🎯 Expectativas</h3>
      <div className="text-sm leading-relaxed text-mut">Pérdida de grasa saludable: ~0.25-0.3 kg/sem con déficit de ~300 kcal. Abs visibles requieren ~10-12% de grasa — la mayoría subestima cuánto falta. El mismo peso con más músculo se ve muy distinto.</div>
    </div>
  );
}
