  ...
  return (
    <div ref={rootRef}>
      ...
      <div className="field">
        ...
        <input id="slotedit-nombre" ref={inputRef} className="w-full" value={name} onChange={e => setName(e.target.value)} placeholder="Pecho / Tríceps" />
      </div>
      ...
      <button ref={btnRef} type="button" className="btn" style={{ marginTop: 16 }} onClick={guardar}>Guardar</button>
    </div>
  );
}
