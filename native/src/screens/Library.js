...
const styles = StyleSheet.create({
  ...
  ghostBtn: { paddingVertical: 12, alignItems: 'center', borderRadius: 10, backgroundColor: C.card2, marginBottom: 4 },
  ...
  useBtn: { paddingHorizontal: 16, paddingVertical: 10, borderRadius: 10, backgroundColor: C.card2 },
  ...
  fieldInput: { color: C.txt, fontSize: 15, paddingVertical: 10, paddingHorizontal: 12, borderRadius: 10, backgroundColor: C.card2 },
