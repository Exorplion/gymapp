...
const styles = StyleSheet.create({
  ...
  ghostBtn: { marginTop: 16, paddingVertical: 12, alignItems: 'center', borderRadius: 10, backgroundColor: C.card2, },
  ...
  heroCard: { backgroundColor: C.card, borderRadius: R.r, padding: 20, borderWidth: 1, borderColor: C.violetLine },
  heroEyebrow: { color: C.violet, fontSize: 12, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 0.5 },
  heroName: { color: C.txt, fontSize: T.display, fontFamily: 'BarlowCondensed_700Bold_Italic', fontWeight: '700', marginTop: 4 },
  ...
  wbarFill: { width: '100%', borderRadius: 4, backgroundColor: C.bg2 },
  wbarOn: { backgroundColor: C.violet },
  wbarLabel: { color: C.mut, fontSize: 10, marginTop: 4 },
  btnRow: { flexDirection: 'row', gap: 10, marginTop: 16 },
  btn: { flex: 1, paddingVertical: 13, alignItems: 'center', borderRadius: 12, backgroundColor: C.card2 },
  ...
  dayBadge: { width: 28, height: 28, borderRadius: 14, backgroundColor: C.violet, alignItems: 'center', justifyContent: 'center' },
  ...
  miniBtn: { width: 28, height: 28, borderRadius: 8, alignItems: 'center', justifyContent: 'center', backgroundColor: C.card2 },
