...
const styles = StyleSheet.create({
  ...
  statNum: { color: C.txt, fontSize: 22, fontWeight: '700' },
  ...
  ctaBtnText: { color: C.txt, fontWeight: '700', fontSize: 15 },
  ...
  smallBtnText: { color: C.txt, fontWeight: '700', fontSize: 13 },
  ...
  histTitle: { color: C.txt, fontSize: 14 },
  histDate: { color: C.mut, fontSize: 13 },
  mvRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 3 },
  mvCat: { color: C.mut, fontSize: 13 },
  ...
  sheetSub: { color: C.mut, fontSize: 14, lineHeight: 20, marginBottom: 14 },
  sheetB: { color: '#6ea8ff', fontWeight: '700' },
  calcbox: { backgroundColor: C.line, borderRadius: 12, padding: 12, marginTop: 10 },
  calcboxText: { color: C.mut, fontSize: 14, lineHeight: 20 },
});
