...
function ElapsedTimer({ start }) {
  ...
  return <Text style={[styles.elapsed, { fontVariant: ['tabular-nums'] }]}>{fmtMMSS(Math.floor((Date.now() - start) / 1000))}</Text>;
}
...
const styles = StyleSheet.create({
  ...
  backText: { color: C.blue, fontSize: 14, fontFamily: 'Barlow_600SemiBold', fontWeight: '600' },
  title: { color: C.txt, fontSize: T.display, fontFamily: 'Barlow_700Bold', fontWeight: '700', marginBottom: 16 },
  reorderBtn: { alignSelf: 'flex-start', backgroundColor: C.card2, borderRadius: 12, paddingHorizontal: 14, paddingVertical: 8, marginTop: 14 },
  ...
  okBtn: { backgroundColor: C.ok },
  dimBtn: { backgroundColor: C.card2 },
  smallBtnText: { color: C.txt, fontFamily: 'Barlow_700Bold', fontWeight: '700', fontSize: T.sm },
  sect: { color: C.mut, fontSize: 12, fontFamily: 'Barlow_700Bold', fontWeight: '700', textTransform: 'uppercase', marginTop: 20, marginBottom: 8 },
  histRow: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: C.line },
  histTitle: { color: C.txt, fontSize: 14, fontFamily: 'Barlow_500Medium' },
  histDate: { color: C.mut, fontSize: T.sm, fontFamily: 'Barlow_400Regular' },
  mvRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 3 },
  mvCat: { color: C.mut, fontSize: T.sm, fontFamily: 'Barlow_400Regular' },
  mvNum: { color: C.mut, fontSize: T.sm, fontFamily: 'Barlow_600SemiBold', fontWeight: '600' },
  pbar: { height: 6, borderRadius: 3, backgroundColor: C.bg2, overflow: 'hidden' },
  pbarFill: { height: '100%', borderRadius: 3, backgroundColor: C.blue },
  mvNote: { color: C.mut, fontSize: T.sm, fontFamily: 'Barlow_400Regular', lineHeight: 18, marginTop: 4 },
  sinGrupo: { marginTop: 12, padding: 12, borderRadius: 12, backgroundColor: 'rgba(255,179,71,.1)' },
  sinGrupoT: { color: C.warn, fontSize: T.sm, fontFamily: 'Barlow_700Bold', fontWeight: '700' },
  sinGrupoS: { color: C.mut, fontSize: T.micro, fontFamily: 'Barlow_400Regular', marginTop: 4 },
  sinGrupoA: { color: C.warn, fontSize: 12, fontFamily: 'Barlow_700Bold', fontWeight: '700', marginTop: 6 },
  sheetWrap: { paddingHorizontal: 20 },
  sheetH2: { color: C.txt, fontSize: 20, fontFamily: 'Barlow_700Bold', fontWeight: '700', marginBottom: 8 },
  sheetSub: { color: C.mut, fontSize: 14, fontFamily: 'Barlow_400Regular', lineHeight: 20, marginBottom: 14 },
  sheetB: { color: '#6ea8ff', fontFamily: 'Barlow_700Bold', fontWeight: '700' },
  calcbox: { backgroundColor: C.card2, borderRadius: 12, padding: 12, marginTop: 10 },
  calcboxText: { color: C.mut, fontSize: 14, fontFamily: 'Barlow_400Regular', lineHeight: 20 },
});
