      ...
      {(T.state === 'fullscreen' || sonandoAhora) && (
        <View style={styles.overlay}>
          <View style={styles.inner}>
            <Text style={styles.lbl}>{sonandoAhora ? '¡Dale!' : 'Descanso'}</Text>
            <View style={styles.ringWrap}>
              <Svg width={200} height={200} viewBox="0 0 200 200">
                ...
                <Circle
                  cx={100} cy={100} r={88}
                  stroke="url(#restGrad)" strokeWidth={12} fill="none"
              ...
              <Text style={styles.ringTime}>{sonandoAhora ? '¡YA!' : timeStr}</Text>
            </View>
...
const styles = StyleSheet.create({
  ...
  pararBtn: { backgroundColor: '#e0463a', borderRadius: 16, paddingHorizontal: 48, paddingVertical: 18, marginTop: 26 },
  pararBtnText: { color: '#fff', fontSize: 20, fontWeight: '800', letterSpacing: 1 },
