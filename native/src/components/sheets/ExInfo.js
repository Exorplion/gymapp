...
const styles = StyleSheet.create({
  ...
  mediaImg: { flex: 1, aspectRatio: 1, borderRadius: 12, backgroundColor: C.bg2 },
  eqRow: { marginTop: 8 },
  eqTag: { color: C.mut, fontSize: 13, backgroundColor: C.card2, paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8, alignSelf: 'flex-start' },
